function [fglrl] = getGLRLMtextures(GLRLM)
% -------------------------------------------------------------------------
...
fglrl=[textures.SRE,textures.LRE,textures.GLN,textures.RLN,textures.RP,textures.LGRE,textures.HGRE,textures.SRLGE,textures.SRHGE,textures.LRLGE,textures.LRHGE,textures.GLV,textures.RLV];
end
