function [result] = getGLSZMtextures(GLSZM)
% -------------------------------------------------------------------------
...
%     Computer Graphics and Image Processing, 4(2), 172â€?79.
...
%     Recognition and Information Processing (PRIP) (pp. 140â€?45).
% -------------------------------------------------------------------------
% INPUTS:
...
result=[textures.SZE,textures.LZE,textures.GLN,textures.ZSN ,textures.ZP,textures.LGZE,textures.HGZE,textures.SZLGE,textures.SZHGE,textures.LZLGE,textures.LZHGE ,textures.GLV,textures.ZSV ];
end
